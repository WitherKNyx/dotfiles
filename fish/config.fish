...
alias imagediff "compare -compose src"
alias pacman-linux "sudo pacman -Sy linux linux-headers linux-lts linux-lts-headers"
alias pacman-sync "sudo pacman -Syu --ignore linux --ignore linux-headers --ignore linux-lts --ignore linux-lts-headers"
#alias pbrt-render "./pbrt <file>; ./imgtool convert <exrname> <pngname>; open <pngname>"
